...
wget -P /tmp/ http://download.elasticsearch.org/kibana/kibana/kibana-4.0.0-beta3.tar.gz
tar xvf /tmp/kibana-4.0.0-beta3.tar.gz; rm -f /tmp/kibana-4.0.0-beta3.tar.gz
